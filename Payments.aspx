                    ...
                    <table id="TabFilters">                        
                        <tr>          
                            ...
                            <td>
                                ...
                                <asp:RegularExpressionValidator ID="revDateFrom" runat="server" ErrorMessage="Wrong date! (dd.MM.yyyy)" ValidationExpression="^(((0[1-9]|[12]\d|3[01])\.(0[13578]|1[02])\.((19|[2-9]\d)\d{2}))|((0[1-9]|[12]\d|30)\.(0[13456789]|1[012])\.((19|[2-9]\d)\d{2}))|((0[1-9]|1\d|2[0-8])\.02\.((19|[2-9]\d)\d{2}))|(29\.02./((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$" ControlToValidate="tbDateFrom"  CssClass="RequredField" ValidationGroup="1" Enabled="False" ></asp:RegularExpressionValidator>
                            </td>
                            <td style="padding-left:1vw"></td>
                            <td>
                               Date To:
                            ...
                            <td>
                                ...
                                <asp:RegularExpressionValidator ID="revDateTo" runat="server" ErrorMessage="Wrong date! (dd.MM.yyyy)" ValidationExpression="^(((0[1-9]|[12]\d|3[01])\.(0[13578]|1[02])\.((19|[2-9]\d)\d{2}))|((0[1-9]|[12]\d|30)\.(0[13456789]|1[012])\.((19|[2-9]\d)\d{2}))|((0[1-9]|1\d|2[0-8])\.02\.((19|[2-9]\d)\d{2}))|(29\.02./((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$" ControlToValidate="tbDateTo"  CssClass="RequredField" ValidationGroup="1" Enabled="False" ></asp:RegularExpressionValidator>
                            </td>
                            <td style="padding-left:1vw"></td>
                    ...
                    <table class="EditDetailsStandard" style="text-align:right; vertical-align:top;">
                        ...
                        <tr>
                            ...
                            <td style="text-align:left">
                                ...
                                <asp:RegularExpressionValidator ID="revAddDateOfPayment" runat="server" ErrorMessage="Wrong date! (dd.MM.yyyy)" ValidationExpression="^(((0[1-9]|[12]\d|3[01])\.(0[13578]|1[02])\.((19|[2-9]\d)\d{2}))|((0[1-9]|[12]\d|30)\.(0[13456789]|1[012])\.((19|[2-9]\d)\d{2}))|((0[1-9]|1\d|2[0-8])\.02\.((19|[2-9]\d)\d{2}))|(29\.02./((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$" ControlToValidate="tbAddDateOfPayment"  CssClass="RequredField" ValidationGroup="1" Enabled="False" ></asp:RegularExpressionValidator>
                            </td>
                        </tr>
                        <tr>
